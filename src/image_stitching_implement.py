...
if __name__ == '__main__':
    ...
    img_matched = cv2.drawMatches(img1, keypoints1, img2, keypoints2, match, None, None, None,
    ...
    cv2.imshow(f'Planar Image Stitching with My RANSAC (score={sum(inlier_mask)})', merge)
    cv2.waitKey(0)
